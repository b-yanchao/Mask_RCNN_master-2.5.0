...
class DrugDataset(utils.Dataset):
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, dataset_root_path):
        ...
        self.add_class("shapes", 1, "board")
        self.add_class("shapes", 2, "person")
        self.add_class("shapes", 3, "plant")
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            if labels[i].find("board") != -1:
                # print "box"
                labels_form.append("board")
            elif labels[i].find("person") != -1:
                labels_form.append("person")
            elif labels[i].find("plant") != -1:
                labels_form.append("plant")
...
dataset_val.load_shapes(100, img_floder, mask_floder, imglist,dataset_root_path)
dataset_val.prepare()
